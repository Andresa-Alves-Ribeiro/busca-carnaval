...
import SwitchBody from "../components/SwitchBody/SwitchBody";
...
function Home() {
  ...
  const [searchedCards, setSearchedCards] = useState([...cardsData]);
    ...
    <div className={styles.carnavalContainer}>
      ...
      <div className={styles.results}>
        <div className={styles.headerResults}>
          ...
          <SwitchBody toggle={toggle} onClick={onClick} />
        </div>
        {toggle ? <RecomendedBlocks cards={searchedCards} /> : <Map cards={cardsData}/>}
      </div>
      <Footer />
    </div>
  );
